...
# returns three dicts: one containing all header values, one with all tables, and one with all graph data
def get_all_data():
...
#for a given dictionary in the form {titles:dataframes}, print the title and dataframe of each item in the dict
