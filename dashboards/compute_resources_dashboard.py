...
graphs_dict = graphs_class.get_graphs_from_queries(queries, sum_by=["namespace", "pod"])
...
if not get_graphs_as_single_df:
    ...
    graphs_df = graphs_class.get_graphs_as_one_df(graphs_dict, sum_by=["namespace", "pod"])
    print(graphs_df)
