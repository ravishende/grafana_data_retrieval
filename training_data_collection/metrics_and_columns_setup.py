...
_non_static_metrics = [
    metric for metric in _all_metrics if metric not in _static_metrics]
...
_duration_col_names = ["duration_t" +
                       str(num) for num in range(1, (_num_duration_cols+1))]
...
_col_names_by_time = _init_col_names_by_time(
    _num_duration_cols, _non_static_metrics)
